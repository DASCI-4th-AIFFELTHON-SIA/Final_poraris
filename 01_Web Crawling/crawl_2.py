...
OUTPUT_JSON_FILE       = r"E:\CODESTORE\data_scienceProjects\modulabs\AiffelThon\yonhapnews_crawl1.jsonl"

USER_AGENT       = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
CRAWL_DELAY_MIN  = 2
CRAWL_DELAY_MAX  = 4

START_YEAR, START_MONTH = 2018, 1   # inclusive
END_YEAR,   END_MONTH   = 2018, 12  # inclusive

PAGE_WORKERS    = 8    # sitemap 페이지 병렬 수
ARTICLE_WORKERS = 20   # 기사 병렬 수 (네트워크 상황에 맞게 조절)
