...
OUTPUT_JSON_FILE       = 'c:/Users/nini/Desktop/NOLB/data/2.jsonl'

USER_AGENT       = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
CRAWL_DELAY_MIN  = 2
CRAWL_DELAY_MAX  = 4

START_YEAR, START_MONTH = 2019, 1   # inclusive
END_YEAR,   END_MONTH   = 2019, 2  # inclusive

PAGE_WORKERS    = 1    # sitemap 페이지 병렬 수
ARTICLE_WORKERS = 70   # 기사 병렬 수 (네트워크 상황에 맞게 조절)
